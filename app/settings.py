...
SUBSTRATE_RPC_URL = os.environ.get(
    "SUBSTRATE_RPC_URL", "http://47.100.239.204:9988/")
...
FINALIZATION_BY_BLOCK_CONFIRMATIONS = int(
    os.environ.get("FINALIZATION_BY_BLOCK_CONFIRMATIONS", 0))
...
LEGACY_SESSION_VALIDATOR_LOOKUP = bool(
    os.environ.get("LEGACY_SESSION_VALIDATOR_LOOKUP", False))
...
SUBSTRATE_STORAGE_INDICES = os.environ.get(
    "SUBSTRATE_STORAGE_INDICES", "EnumSet")
NEW_SESSION_EVENT_HANDLER = bool(
    os.environ.get("NEW_SESSION_EVENT_HANDLER", False))
BALANCE_SYSTEM_ACCOUNT_MIN_BLOCK = int(
    os.environ.get("BALANCE_SYSTEM_ACCOUNT_MIN_BLOCK", 0))
